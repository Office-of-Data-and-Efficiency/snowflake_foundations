...
1. [About Snowflake and Snowsight](about_snowflake.md)  
2. [Snowsight Interface Overview](snowsight.md)  
3. [Environment Setup (Role, Warehouse, Database)](environment_setup.md)  
4. [Loading Data](load_data.md)  
...
Proceed through each module in order.
